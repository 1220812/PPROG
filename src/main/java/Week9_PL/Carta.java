...
public class Carta implements Comparable<Carta> {
    ...
    /**
     * Compara os naipes e, caso o naipe for o mesmo, compara o tipo de duas cartas
     * @param o outra carta a ser comparada.
     * @return diferença entre os naipes ou tipos (caso o naipe seja o mesmo)
     */
    @Override
    public int compareTo(Carta o) {
        int resultado = this.getNaipe().compareTo(o.getNaipe());
        // se as cartas forem do mesmo naipe, ordena por tipo
        if(resultado == 0){
            resultado = this.getTipo().compareTo(o.getTipo());
        }
        return resultado;
    }
}
